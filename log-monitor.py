    ...
    with open(log_file, 'r') as file:
        ...
        try:
            while True:
                ...
                # Check if 20 seconds have passed since the script started
                if time.time() - start_time >= 300 and not log_file_name_warning_shown:
                    logger.warning("No new error found after the last scan. Hence stopped the script.")
                    log_file_name_warning_shown = True
                    break  # Stop monitoring after 20 seconds
